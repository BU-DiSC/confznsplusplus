...
static Property femu_props[] = {
    ...
    // ZNS lat
    DEFINE_PROP_UINT64("zns_page_read_latency", FemuCtrl, zns_params.pg_rd_lat, 60000),
    DEFINE_PROP_UINT64("zns_page_write_latency", FemuCtrl, zns_params.pg_wr_lat, 700000),
    DEFINE_PROP_UINT64("zns_block_erasure_latency", FemuCtrl, zns_params.blk_er_lat, 3500000),
    DEFINE_PROP_UINT64("zns_channel_transfer_latency", FemuCtrl, zns_params.ch_xfer_lat, 25000),
    // ZNS Geo
    DEFINE_PROP_UINT64("zns_block_size_pages", FemuCtrl, zns_params.block_size, 768),
    DEFINE_PROP_UINT64("zns_zonesize", FemuCtrl, zns_params.zone_size, (1 * GiB)),
    ...
    DEFINE_PROP_UINT64("zns_vchunk_size", FemuCtrl, zns_params.vchunk_size, 1),
